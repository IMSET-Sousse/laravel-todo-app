...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
            ...
            <table>
                <thead>
                    <tr><td>Id</td><td>Item</td><td>Status</td><td>Actions</td></tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td>{{ $listItem->id}}</td>
                        <td>{{ $listItem->name}}</td>
                        <td>{{ $listItem->is_complete == 0 ? 'Not yet' : 'Done' }}</td>
                        <td>
                            ...
                            @else
                                <form action="{{ route('markNotYet', $listItem->id)}}" method="post">
                                    {{ csrf_field() }}
                                    <input type="submit" value="Mark not yet"/>
                                </form>
                            @endif
